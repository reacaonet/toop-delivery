...
#variables
path="/home/home/ecbr/microservice_payment"
...
if [ $type = "homologation" ]; then
  path="/home/app/ecbr_microservice_payment"
  path_package="${path}/package.json"
...
sleep 2
docker stop payment-microservice
sleep 5
...
npx yarn server 
sleep 5
echo "::: Preparando para o sequelize migrate"
