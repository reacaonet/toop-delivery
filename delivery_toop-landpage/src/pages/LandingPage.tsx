          ...
          <div className="lp-apps-inner">
            <div className="lp-apps-text">
              ...
              <div className="lp-apps-buttons">
                <a href={LINKS.storeAppGoogle || '/'} className="lp-store-badge" target="_blank" rel="noopener noreferrer" aria-label="Disponível no Google Play">
                ...
                <a href={LINKS.storeAppApple || '/'} className="lp-store-badge" target="_blank" rel="noopener noreferrer" aria-label="Disponível na App Store">
