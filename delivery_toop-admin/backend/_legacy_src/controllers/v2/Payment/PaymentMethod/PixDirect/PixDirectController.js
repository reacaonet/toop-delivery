...
let tip = null;
let typePayment = "PIX_DIRECT";
const valueMin = 0.09;

/**
 * url - /v2/payment/pix-direct/send/cart/:cartId
 * POST
 * - customer
 */
const sendPixDirect = async (req, res) => {
  try {
    ...
    const { customer, ipAddress, coupon, valueTip, typeSchedule, deliveryFree, usedCashback } = req.body;
    tip = null;
    ...
    await LogModel.create({
      path: '/src/controllers/v2/Payment/PaymentMethod/PixDirect/PixDirectController.js',
      error: err?.message,
      method: 'sendPix',
      type: 'error',
      level: 0,
