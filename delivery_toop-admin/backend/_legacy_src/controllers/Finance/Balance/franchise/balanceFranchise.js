...
const balanceFranchise = async (req, res) => {
  try {
  ...
  await LogModel.create({
    path: 'src/controllers/Finance/Balance/franchise/balanceFranchise.js',
    error: err?.message,
    method: 'balanceFranchise',
    type: 'error',
    level: 0,
    origin: 'backend',
    request: {
...
module.exports = balanceFranchise;
