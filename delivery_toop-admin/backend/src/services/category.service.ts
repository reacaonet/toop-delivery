...
export class CategoryService {
  async create(data: { name: string; company: string; description?: string; image?: string; order?: number }) {
  ...
  async update(id: string, data: Partial<{ name: string; description?: string; image?: string; order?: number; active?: boolean }>) {
