...
const MapFastBoarding = ({
  ...
  //       region?.longitude !== 0
  //     ) {
  //       nearbyDrivers(region?.latitude, region?.longitude).then((result: any) => {
    ...
    <>
      ...
      {region && region?.latitude !== 0 && region?.longitude !== 0 ? (
        <MapView
          ...
          {destination && destination?.latitude ? (
            <>
              {chosenOrigin &&
                ...
                destination &&
                destination?.latitude && overviewPolyline && Array.isArray(overviewPolyline) && overviewPolyline.length > 0 ? (
                <Polyline
          ...
          {/* {listDrivers && Array.isArray(listDrivers) && listDrivers.length > 0 ? listDrivers.map((item: any) => {
            return (
              <Marker
...
export default memo(MapFastBoarding);
