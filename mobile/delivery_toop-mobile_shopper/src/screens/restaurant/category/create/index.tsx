...
import {createCategory} from './../../../../services/provider/shopping/category';
...
const Create: React.FC<DepartmentProps> = () => {
  ...
  const onSubmitCreate = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await createCategory(company._id, {
        name,
        isPaused,
        position,
        company: company._id,
      ...
      Alert.alert('Tente novamente', 'Erro ao cadastrar categoria');
    }
    setIsLoading(false);
  };
