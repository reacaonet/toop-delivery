...
import ReferralCode from '../screens/customer/ReferralCode';
import Genre from '../screens/customer/Genre';
      ...
      <Drawer.Navigator
        ...
        {!props.userAuth || props.userAuth === null || !props.userAuth?._id ? (
          ...
          <>
            ...
            />
            <Drawer.Screen
              name="RideAndTravelStack"
              component={RideAndTravelStack}
              options={{unmountOnBlur: true}}
            />
            <Drawer.Screen
              name="Search"
