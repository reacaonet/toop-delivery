...
const Departments = ({
  ...
  const lazyLoadDepartment = async (idDepartment, numberProducts) => {
    try {
      ...
      if (respNext && respNext.length > 0) {
        ...
        updateListDepartment(idDepartment, []);
      }
  ...
  const updateListDepartment = (idDepartment, products) => {
    try {
      ...
      if (products.length > 0) {
        ...
        listBefore[index].numberProducts = 1;
  ...
  const getListProducts = itemProducts => {
    ...
    let numberProducts = itemProducts?.numberProducts ?? 0;
                ...
                <View style={stylesNew.BoxInfo}>
                  <View style={stylesNew.priceContainer}>
                    <Text style={stylesNew.txtValue}>
                      {item.pricePromotion
                        ? maskRealBeautify(item.pricePromotion, true)
                        : maskRealBeautify(item.price, true)}
                    </Text>
                    {item.pricePromotion ? (
                      <>
                        <Text style={stylesNew.pricePromotion}>
                          {maskRealBeautify(item.price)}
                        </Text>
                      </>
                    ) : null}
                  </View>
                  ...
                  <Text style={stylesNew.txtNameProd} numberOfLines={2}>
                    {item?.name}
                  </Text>
