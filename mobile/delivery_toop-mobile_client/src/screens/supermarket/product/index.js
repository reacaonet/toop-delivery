...
const Product = ({
              ...
              <>
                <View style={styles.priceContainer}>
                  <Text style={styles.txtValue}>
                    {item.pricePromotion
                      ? formatMoney(item.pricePromotion, configurations?.coin)
  ...
  const clickOpenMap = async address => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ImageBackground
        ...
        <View style={styles.BoxCompany}>
          ...
          <View style={{flexShrink: 1}}>
            ...
            <Text style={styles.SubTitleCompany} numberOfLines={2}>
      ...
      {company?.companyCategory === 'service' ? (
        <ContainerService>
          <ContainerAddress onPress={() => clickOpenMap(company?.address)}>
            <AddressText>Endereço: {company?.address}</AddressText>
          </ContainerAddress>
        </ContainerService>
      ) : null}
...
const mapStateToProps = ({cart, user}) => {
  ...
  return {
    ...
    qtdProd: sumItens || cart?.cart?.length || 0,
    price: cart.subTotal,
